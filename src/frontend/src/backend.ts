...
import type { ExternalBlob as _ExternalBlob, PropertyListing as _PropertyListing, PropertyListingInput as _PropertyListingInput, PropertyStatus as _PropertyStatus, PropertyType as _PropertyType, SearchFilters as _SearchFilters, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createPropertyListing(arg0: PropertyListingInput): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createPropertyListing(await to_candid_PropertyListingInput_n10(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getListing(arg0: string): Promise<PropertyListing> {
        if (this.processError) {
            try {
                const result = await this.actor.getListing(arg0);
                return from_candid_PropertyListing_n17(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getListingCountByCity(): Promise<Array<[string, bigint]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getListingCountByCity();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getListingsByOwner(arg0: Principal): Promise<Array<PropertyListing>> {
        if (this.processError) {
            try {
    ...
    async getMostViewedListings(arg0: bigint): Promise<Array<PropertyListing>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMostViewedListings(arg0);
                return from_candid_vec_n16(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPropertyTypes(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPropertyTypes();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserFavorites(): Promise<Array<string>> {
        if (this.processError) {
            try {
    ...
    async markListingAvailable(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markListingAvailable(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markListingRented(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markListingRented(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchPropertyListings(arg0: SearchFilters): Promise<Array<PropertyListing>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchPropertyListings(to_candid_SearchFilters_n33(this._uploadFile, this._downloadFile, arg0));
                return from_candid_vec_n16(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePropertyListing(arg0: string, arg1: PropertyListingInput): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePropertyListing(arg0, await to_candid_PropertyListingInput_n10(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_PropertyListing_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PropertyListing): Promise<PropertyListing> {
    return await from_candid_record_n18(_uploadFile, _downloadFile, value);
}
function from_candid_PropertyStatus_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PropertyStatus): PropertyStatus {
    return from_candid_variant_n20(_uploadFile, _downloadFile, value);
}
function from_candid_PropertyType_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PropertyType): PropertyType {
...
async function from_candid_record_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        status: from_candid_PropertyStatus_n19(_uploadFile, _downloadFile, value.status),
        title: value.title,
        ownerName: value.ownerName,
        propertyType: from_candid_PropertyType_n21(_uploadFile, _downloadFile, value.propertyType),
...
function from_candid_variant_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "rented" in value ? PropertyStatus.rented : "available" in value ? PropertyStatus.available : value;
}
function from_candid_variant_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "pg" in value ? PropertyType.pg : "studio" in value ? PropertyType.studio : "bhk1" in value ? PropertyType.bhk1 : "bhk2" in value ? PropertyType.bhk2 : "bachelorRoom" in value ? PropertyType.bachelorRoom : "hostel" in value ? PropertyType.hostel : value;
}
...
async function from_candid_vec_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PropertyListing>): Promise<Array<PropertyListing>> {
    return await Promise.all(value.map(async (x)=>await from_candid_PropertyListing_n17(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_PropertyListingInput_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: PropertyListingInput): Promise<_PropertyListingInput> {
...
function to_candid_SearchFilters_n33(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: SearchFilters): _SearchFilters {
...
function to_candid_record_n34(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        propertyType: value.propertyType ? candid_some(to_candid_PropertyType_n12(_uploadFile, _downloadFile, value.propertyType)) : candid_none(),
        minRent: value.minRent ? candid_some(value.minRent) : candid_none(),
        city: value.city ? candid_some(value.city) : candid_none(),
        keyword: value.keyword ? candid_some(value.keyword) : candid_none(),
        maxRent: value.maxRent ? candid_some(value.maxRent) : candid_none()
    };
}
function to_candid_variant_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: PropertyType): {
    ...
    return value == PropertyType.pg ? {
        ...
        studio: null
    } : value == PropertyType.bhk1 ? {
        bhk1: null
    } : value == PropertyType.bhk2 ? {
        bhk2: null
    } : value == PropertyType.bachelorRoom ? {
        bachelorRoom: null
    } : value == PropertyType.hostel ? {
        hostel: null
    } : value;
}
